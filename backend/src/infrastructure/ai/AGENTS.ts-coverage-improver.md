...
- If a coverage scanner tool is already installed please use that, otherwise please perform the code coverage analysis yourself. However, if you do choose to install anything, please make sure you clean up and add any new files created (other than the test file(s) and ;;coverageFileSummaryName;;) to the .gitignore. Create a .gitnore for this purpose if one does not already exist.
